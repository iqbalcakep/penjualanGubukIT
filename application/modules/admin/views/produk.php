...
<body class="fix-header fix-sidebar card-no-border">
                                    ...
                                    <table class="table" id="produk">
                                        ...
                                        <?php $no=1; foreach ($produk as $v) : ?>
                                            <tr>
                                                ...
                                                <td><?php echo $v->stok_produk ?></td>
                                                <td><img class="img-circle" src="<?= base_url()?>assets/file/<?php echo $v->gambar_produk ?>" height="150" width="200"></td>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            CKEDITOR.replace('deskripsi_produk2'); //ckeditor
        ...
        $('#produk tbody').on( 'click', '#hapus', function () { //hapus data
            ...
            if(confirm){
                ...
                $.ajax({
                     url:'<?php echo base_url();?>admin/Produk/deleteProduk',
                     type:"post",
        ...
        $("#formAdd").submit(function(e){ //form add submit
            ...
            $.ajax({
                     url:'<?php echo base_url();?>admin/Produk/saveProduk',
                     type:"post",
                     data:formData,
                     dataType:"json",
                     processData:false,
        ...
        $("#formEdit").submit(function(e){ //form edit
            ...
            $.ajax({
                     url:'<?php echo base_url();?>admin/Produk/updateProduk',
                     type:"post",
                     data:formData,
                     dataType:"json",
                     processData:false,
